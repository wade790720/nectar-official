...
const messages = {
  en: {
    ...
    metaCourseTitle: "Course · Nectar Artistry",
    metaCourseDesc:
      "Classroom information for Taipei, Taichung, and Tainan, with quick contact channels for enrollment.",
    ...
    galleryCourseNameEn: "English name",
    galleryCourseSave: "Save",
    galleryCourseRemove: "Remove",
    galleryCourseUpload: "Click to upload",
    galleryCourseReplace: "Click to replace",
    galleryCourseDeleteConfirm:
      "Remove this course from the gallery? Its photo will be permanently deleted. This cannot be undone.",
    galleryWorksEmpty: "No works to show yet.",
    galleryOrderHint: "The first 6 below appear on the home page. Use ↑ / ↓ to change order.",
    galleryMoveUp: "Move up",
    galleryMoveDown: "Move down",
    galleryReorderHint: "Reorder works",
    voteIndexKicker: "The Index",
    voteRowViewers: "votes",
    voteGotoCourse: "Go to course page",
    courseKicker: "Course",
    courseTitle: "Classroom",
    courseSub: "Choose a city below to view enrollment details and schedule.",
    courseMainSite: "Academy main site",
    courseTaipei: "Taipei",
    ...
    detailUploadAdded: "Added {n} photo(s).",
  ...
  "zh-TW": {
    ...
    metaCourseTitle: "課程 · Nectar Artistry",
    metaCourseDesc: "台北、台中、台南課程資訊與報名入口，底部可快速聯絡社群。",
    ...
    wishEmpty: "成為第一個寫下的人。",
    wishReset: "重設所有票數",
    wishDeleteTitle: "刪除願望",
    wishDeleteConfirm: "確定要從願望池刪除這則嗎？無法復原。",
    wishDeleteLabel: "刪除願望",
    galleryKicker: "畫廊",
    galleryTitle: "畫廊",
    ...
    galleryCourseNameZh: "中文名稱",
    galleryCourseNameEn: "英文名稱",
    galleryCourseSave: "儲存",
    galleryCourseRemove: "移除",
    galleryCourseUpload: "點此上傳",
    galleryCourseReplace: "點此更換",
    galleryCourseDeleteConfirm:
      "確定要從畫廊移除這堂課嗎？照片也會一併刪除，無法復原。",
    galleryWorksEmpty: "尚無藝術品可顯示。",
    galleryOrderHint: "前 6 則藝術品會出現在首頁。可用 ↑ / ↓ 調整顯示順序。",
    galleryMoveUp: "上移",
    galleryMoveDown: "下移",
    galleryReorderHint: "調整作品順序",
    voteIndexKicker: "花種索引",
    voteRowViewers: "票",
    voteGotoCourse: "前往課程頁",
    courseKicker: "課程",
    courseTitle: "課程資訊",
    courseSub: "選擇城市查看報名方式與開課資訊。",
    courseMainSite: "學院主體首頁",
    courseTaipei: "台北",
    courseTaichung: "台中",
    courseTainan: "台南",
    courseGoLink: "開啟報名連結",
